...
function CompanyHistoryEventList(){
    useEffect(() => {
        ...
        <main>
            <section>
                <MiniHero heroImage="https://images.pexels.com/photos/19130866/pexels-photo-19130866.jpeg" 
                    ...
                    headingText="Historia waszych wydarzeń" 
                    subheadingText = "Wszystkie wasze wydarzenia, które się odbyły"/>
            </section>
            <section>
...
export default CompanyHistoryEventList;